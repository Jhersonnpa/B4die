...
<body onload="getLocation()">
        ...
        <div class="nav-top">
            <div id="search">
                <form action="" role="search" id="searchform">
                    ...
                    <input required type="text" placeholder="Busca tu experiencia" id="s"/>
                </form>
            </div>
    ...
    <div class="modal__container">
        <form action="" method="post">
            ...
            <input required type="text" name="Asunto" id="Asunto" placeholder="Asunto">
            <label for="msj"><i class='bx bx-envelope'></i> Mensaje</label>
            <textarea name="msj" id="msj" cols="30" rows="10"></textarea>
            <input required type="submit" value="Enviar mensaje" name="submit">
        </form>
        <button class="modal__close jsModalClose"><i class='bx bx-x-circle' style='color:#feaf26'  ></i></button>
    </div>
    </div>

    <form action='<?=base_url('/editadaActivitat')?>' method='post' enctype='multipart/form-data'>
    <?= csrf_field() ?>
